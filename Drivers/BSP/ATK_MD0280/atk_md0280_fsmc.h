...
#define ATK_MD0280_FSMC_CLK_ENABLE() \
    do                               \
    {                                \
        __HAL_RCC_FSMC_CLK_ENABLE(); \
    } while (0) /* ATK-MD0280模块所接FSMC时钟使能 */
...
#define ATK_MD0280_FSMC_RS_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
...
#define ATK_MD0280_FSMC_CS_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOG_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_RD_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
...
#define ATK_MD0280_FSMC_WR_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOD_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D0_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOD_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D1_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOD_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D2_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOD_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D3_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOD_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D4_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
...
#define ATK_MD0280_FSMC_D5_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOE_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D6_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOE_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D7_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOE_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D8_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOE_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D9_GPIO_CLK_ENABLE() \
    do                                       \
    {                                        \
        __HAL_RCC_GPIOE_CLK_ENABLE();        \
    } while (0)
...
#define ATK_MD0280_FSMC_D10_GPIO_CLK_ENABLE() \
    do                                        \
    {                                         \
        __HAL_RCC_GPIOE_CLK_ENABLE();         \
    } while (0)
...
#define ATK_MD0280_FSMC_D11_GPIO_CLK_ENABLE() \
    do                                        \
    {                                         \
        __HAL_RCC_GPIOE_CLK_ENABLE();         \
    } while (0)
...
#define ATK_MD0280_FSMC_D12_GPIO_CLK_ENABLE() \
    do                                        \
    {                                         \
        __HAL_RCC_GPIOE_CLK_ENABLE();         \
    } while (0)
...
#define ATK_MD0280_FSMC_D13_GPIO_CLK_ENABLE() \
    do                                        \
    {                                         \
        __HAL_RCC_GPIOD_CLK_ENABLE();         \
    } while (0)
...
#define ATK_MD0280_FSMC_D14_GPIO_CLK_ENABLE() \
    do                                        \
    {                                         \
        __HAL_RCC_GPIOD_CLK_ENABLE();         \
    } while (0)
...
#define ATK_MD0280_FSMC_D15_GPIO_CLK_ENABLE() \
    do                                        \
    {                                         \
        __HAL_RCC_GPIOD_CLK_ENABLE();         \
    } while (0)
